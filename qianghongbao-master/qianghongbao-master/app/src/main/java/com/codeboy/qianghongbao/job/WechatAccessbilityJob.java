...
public class WechatAccessbilityJob extends BaseAccessbilityJob {
    ...
    AccessibilityNodeInfo nodeInfo,sendmessage,sendbutton;
    /** 微信的包名*/
    ...
    public void onReceiveJob(AccessibilityEvent event) {
        ...
        //通知栏事件
//        Log.e("AccessibilityEvent:",event+"");
    ...
    private void notificationEvent(String ticker, Notification nf) {
        ...
        Log.e("text",text+"");
        text = text.trim();
//        if(text.contains("strew:")||text.contains("Jazz:")) { //红包消息
//        newHongBaoNotification(nf);
//        NotifyHelper.getSceen(getContext());
...
//        }
     ...
     */
   // @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    public void handlerClick(String text){
        Log.e("error:","error");
        if(getService() == null){
            Log.w(TAG, "serve爲空");
            return;
        ...
        if(list != null && list.isEmpty()) {
            // 从消息列表查找红包
            AccessibilityNodeInfo node = AccessibilityHelper.findNodeInfosByText(nodeInfo, text);
            if(node != null) {
...
//        Log.e("震动了", "震动了");
//        NotifyHelper.sound(QiangHongBaoService.service.getBaseContext());
//        NotifyHelper.getSceen(testActivity.this);
//        Intent intent = new Intent(Config.BEGINTASK);
//        QiangHongBaoService.service.getBaseContext().sendBroadcast(intent);
//        if(BitmapUtils.ishome){
//            BitmapUtils.handler = getHandler();
//
//            getHandler().postDelayed(new Runnable() {
//                @Override
//                public void run() {
...
////                            Log.e("top",AccessibilityHelper.findNodeInfosById(nodeInfo, "com.tencent.mm:id/aft")+"");
//////                                    notifyHelper.click(getHandler(),AccessibilityHelper.findNodeInfosById(nodeInfo, "com.tencent.mm:id/aft"),1000);
//////                            BitmapUtils.getAllpay("累计收款金额￥0.02，收款笔数1笔");
////                            }
////                    },2000);
//
////                    BitmapUtils.getAllpay("累计收款金额￥0.02，收款笔数1笔");
...
////            AccessibilityNodeInfo trannode = AccessibilityHelper.findNodeInfosByText(nodeInfo, "[微信支付]");
//            if(node != null) {
//                if(BuildConfig.DEBUG) {
//                    Log.i(TAG, "-->微信红包:" + node);
//                }
...
//////                Message message = new Message();
//////                message.what = 6;
//////                ((MainActivity)getContext()).gethandler().sendMessage(message);
////            }
//        } else if(list != null) {
//            if (isReceivingHongbao){
//                //最新的红包领起
