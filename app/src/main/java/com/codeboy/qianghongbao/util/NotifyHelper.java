...
public class NotifyHelper {
    ...
    public static void sound(Context context) {
        try {
            player = MediaPlayer.create(context,
                    Uri.parse(("android.resource://" + context.getPackageName() + "/" + R.raw.morningclick)));
            vibrator(context);
            player.start();
     ...
     * 播放声音
     */
    public static void soundlimt(Context context) {
        try {
            if (startlimit)
                return;
//            player = MediaPlayer.create(context,
//                    Uri.parse(("android.resource://" + context.getPackageName() + "/" + R.raw.transparent_piano)));
                player = MediaPlayer.create(context,
...
//        ((Activity)context).setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
//
//            @Override
//            public void onCompletion(MediaPlayer arg0) {
//                musicPlayer.start();
...
//        if(node == null){
//            handler.sendEmptyMessageDelayed(96,1000);
//        }else{
