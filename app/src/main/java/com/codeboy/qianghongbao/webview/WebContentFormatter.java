...
public class WebContentFormatter implements EventSpeechRule.AccessibilityEventFormatter{
    ...
    @Override
    public boolean format(AccessibilityEvent event, QiangHongBaoService context, Utterance utterance) {
