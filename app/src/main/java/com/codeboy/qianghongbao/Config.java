...
public class Config {
    ...
    public static final String BEGINTASK = "BEGINTASK";
    public static final String NEWBEGINTASK = "NEWBEGINTASK";
    public static final String BEGININSERT = "BEGININSERT";
    ...
    public static final String CHECKIMG = "CHECKIMG";
    public static final String UPDATEWITHROW = "UPDATEWITHROW";
    public static final String GETIP = "GETIP";
    public static final String BEGININSERTTASK = "BEGININSERTTASK";
    public static final String GETFINISHTASK = "GETFINISHTASK";
    public static final String BEGINUPSATE = "BEGINUPSATE";
    public static final String BEGINGETSATE = "BEGINGETSATE";
    public static final String NOTIFYINSERT = "NOTIFYINSERT";
